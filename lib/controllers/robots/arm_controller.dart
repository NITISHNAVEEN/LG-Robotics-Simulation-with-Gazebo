...
class ArmController extends GetxController {
  ...
  void onRotationChanged(StickDragDetails details, String address) {
      ...
      angle = atan2(x, -y);
      print('Joystick 1: x=${x.toStringAsFixed(2)}, y=${y.toStringAsFixed(2)}, angle=${angle.toStringAsFixed(2)}');
      controlsController.sendJointPositions("/joystick_jacobian", [angle, 0.0, 0.0, gripper]);
    ...
    void onPositionChanged(StickDragDetails details) {
      ...
      height = details.y;
      // if (x == 0.0 && y == 0.0) return;
      controlsController.sendJointPositions("/joystick_jacobian", [angle, length, -height, gripper]);
