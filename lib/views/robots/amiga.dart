...
class AmigaExp extends StatelessWidget {
  const AmigaExp({super.key});

  @override
  Widget build(BuildContext context) {
    final ControlsController controlsController = Get.find();
    final AmigaController amigaController = Get.find();
      ...
      child: Column(
        children: [
          ...
          Container(
            ...
            child: const Center(
              child: Text(
                "AmigoBot is a compact, differential-drive mobile robot primarily designed for use in classrooms and research labs. It supports sensors like sonar and encoders, and can be programmed for path planning, obstacle avoidance, and SLAM.",
                style: TextStyle(
                  fontSize: 16,
          ...
          const Divider(),
          const SizedBox(height: 16),
          _buildJoystickControls(amigaController),
        ],
      ),
    );
  }
  ...
  Widget _buildJoystickControls(AmigaController amigaController) {
            ...
            children: [
              SizedBox(
                ...
                child: Joystick(
                  ...
                  listener:
                      (details) =>
                          amigaController.onDriveChanged(details),
